...
parser.add_argument('--lr', default=2e-5, type=float, help='initial learning rate', dest='lr')
parser.add_argument('--scheduler', default="cosine", type=str, help='lr scheduler')
parser.add_argument('--sched', default=None, type=str)
parser.add_argument('--aug', default=0, type=int, help='data-aug (0: none, 1: flips, 2: crop+flip, 3: reflect-crop+flip, 4: crop)')
...
def main():
    ...
    for i, (images, target) in enumerate(recycle(tr_loader)):
        ...
        if args.earlystop and d['Train Loss'] < 0.01:
