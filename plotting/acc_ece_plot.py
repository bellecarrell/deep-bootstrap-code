...
def main():
    ...
    sns.lineplot(data=df, x='Test SoftError', y='Test ece', hue='run')
    fname = f'{args.project}_soft.png'
    plt.legend(bbox_to_anchor=(1.01, 1), borderaxespad=0)
    plt.xlim(0,0.4)
    plt.savefig(fname, bbox_inches='tight')
    plt.clf()        
    sns.lineplot(data=df, x='Test Error', y='Test ece', hue='run')
    plt.legend(bbox_to_anchor=(1.01, 1), borderaxespad=0)
    plt.xlim(0,0.4)
    ...
    sns.lineplot(data=df, x='Test SoftAcc', y='Test ece', hue='run')
    fname = f'{args.project}_softacc.png'
    plt.legend(bbox_to_anchor=(1.01, 1), borderaxespad=0)
    plt.savefig(fname, bbox_inches='tight')
    plt.clf()        
    sns.lineplot(data=df, x='Test Acc', y='Test ece', hue='run')
    plt.legend(bbox_to_anchor=(1.01, 1), borderaxespad=0)
